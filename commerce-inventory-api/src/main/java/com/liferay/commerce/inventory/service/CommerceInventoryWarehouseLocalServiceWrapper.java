...
public class CommerceInventoryWarehouseLocalServiceWrapper
	...
	*/
	...
	@Override
	public java.util.List<com.liferay.commerce.inventory.model.CommerceInventoryWarehouse> getCommerceInventoryWarehousesByGroupId(
		long companyId, long groupId) {
		return _commerceInventoryWarehouseLocalService.getCommerceInventoryWarehousesByGroupId(companyId,
			groupId);
	}

	@Override
	public java.util.List<com.liferay.commerce.inventory.model.CommerceInventoryWarehouse> getCommerceInventoryWarehousesByGroupIdAndActive(
		long companyId, long groupId, boolean active) {
		return _commerceInventoryWarehouseLocalService.getCommerceInventoryWarehousesByGroupIdAndActive(companyId,
			groupId, active);
	}

	@Override
	public java.util.List<com.liferay.commerce.inventory.model.CommerceInventoryWarehouse> getCommerceInventoryWarehousesByGroupIdAndSku(
		long companyId, long groupId, String sku) {
		return _commerceInventoryWarehouseLocalService.getCommerceInventoryWarehousesByGroupIdAndSku(companyId,
			groupId, sku);
	}
	...
	*/
	...
	public java.util.List<com.liferay.commerce.inventory.model.CommerceInventoryWarehouse> search(
		...
		return _commerceInventoryWarehouseLocalService.search(companyId,
			keywords, active, commerceCountryCode, start, end, orderByComparator);
	}
	...
	public int searchCount(long companyId, String keywords, Boolean active,
		...
		return _commerceInventoryWarehouseLocalService.searchCount(companyId,
			keywords, active, commerceCountryCode);
	}
