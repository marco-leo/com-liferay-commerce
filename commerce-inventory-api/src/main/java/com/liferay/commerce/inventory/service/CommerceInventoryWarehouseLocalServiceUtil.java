...
public class CommerceInventoryWarehouseLocalServiceUtil {
	...
	*/
	...
	public static java.util.List<com.liferay.commerce.inventory.model.CommerceInventoryWarehouse> getCommerceInventoryWarehousesByGroupId(
		long companyId, long groupId) {
		return getService()
				   .getCommerceInventoryWarehousesByGroupId(companyId, groupId);
	}

	public static java.util.List<com.liferay.commerce.inventory.model.CommerceInventoryWarehouse> getCommerceInventoryWarehousesByGroupIdAndActive(
		long companyId, long groupId, boolean active) {
		return getService()
				   .getCommerceInventoryWarehousesByGroupIdAndActive(companyId,
			groupId, active);
	}

	public static java.util.List<com.liferay.commerce.inventory.model.CommerceInventoryWarehouse> getCommerceInventoryWarehousesByGroupIdAndSku(
		long companyId, long groupId, String sku) {
		return getService()
				   .getCommerceInventoryWarehousesByGroupIdAndSku(companyId,
			groupId, sku);
	}
	...
	*/
	...
	public static int getCommerceInventoryWarehousesCount(long companyId,
		...
		return getService()
				   .getCommerceInventoryWarehousesCount(companyId, groupId,
			active);
	}
	...
	*/
	...
	public static java.util.List<com.liferay.commerce.inventory.model.CommerceInventoryWarehouse> search(
		...
		return getService()
				   .search(companyId, keywords, active, commerceCountryCode,
	...
	public static int searchCount(long companyId, String keywords,
		...
		return getService()
				   .searchCount(companyId, keywords, active, commerceCountryCode);
	}
