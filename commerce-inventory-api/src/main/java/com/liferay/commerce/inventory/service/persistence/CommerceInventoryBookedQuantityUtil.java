...
public class CommerceInventoryBookedQuantityUtil {
	...
	* @return the matching commerce inventory booked quantities
	*/
	public static List<CommerceInventoryBookedQuantity> findByLt_ExpirationDate(
		Date expirationDate) {
		return getPersistence().findByLt_ExpirationDate(expirationDate);
	}
	...
	*/
	public static List<CommerceInventoryBookedQuantity> findByLt_ExpirationDate(
		...
		return getPersistence()
				   .findByLt_ExpirationDate(expirationDate, start, end);
	}
	...
	* @throws NoSuchInventoryBookedQuantityException if a matching commerce inventory booked quantity could not be found
	*/
	public static CommerceInventoryBookedQuantity findByLt_ExpirationDate_First(
		Date expirationDate,
		OrderByComparator<CommerceInventoryBookedQuantity> orderByComparator)
		throws com.liferay.commerce.inventory.exception.NoSuchInventoryBookedQuantityException {
		return getPersistence()
				   .findByLt_ExpirationDate_First(expirationDate,
			orderByComparator);
	}
	...
	* @return the first matching commerce inventory booked quantity, or <code>null</code> if a matching commerce inventory booked quantity could not be found
	*/
	public static CommerceInventoryBookedQuantity fetchByLt_ExpirationDate_First(
		Date expirationDate,
		OrderByComparator<CommerceInventoryBookedQuantity> orderByComparator) {
		return getPersistence()
				   .fetchByLt_ExpirationDate_First(expirationDate,
			orderByComparator);
	}
	...
	* @throws NoSuchInventoryBookedQuantityException if a matching commerce inventory booked quantity could not be found
	*/
	public static CommerceInventoryBookedQuantity findByLt_ExpirationDate_Last(
		Date expirationDate,
		OrderByComparator<CommerceInventoryBookedQuantity> orderByComparator)
		throws com.liferay.commerce.inventory.exception.NoSuchInventoryBookedQuantityException {
		return getPersistence()
				   .findByLt_ExpirationDate_Last(expirationDate,
			orderByComparator);
	}
	...
	* @return the last matching commerce inventory booked quantity, or <code>null</code> if a matching commerce inventory booked quantity could not be found
	*/
	public static CommerceInventoryBookedQuantity fetchByLt_ExpirationDate_Last(
		Date expirationDate,
		OrderByComparator<CommerceInventoryBookedQuantity> orderByComparator) {
		return getPersistence()
				   .fetchByLt_ExpirationDate_Last(expirationDate,
			orderByComparator);
	}
	...
	* @throws NoSuchInventoryBookedQuantityException if a commerce inventory booked quantity with the primary key could not be found
	*/
	public static CommerceInventoryBookedQuantity[] findByLt_ExpirationDate_PrevAndNext(
		long commerceInventoryBookedQuantityId, Date expirationDate,
		OrderByComparator<CommerceInventoryBookedQuantity> orderByComparator)
		throws com.liferay.commerce.inventory.exception.NoSuchInventoryBookedQuantityException {
		return getPersistence()
				   .findByLt_ExpirationDate_PrevAndNext(commerceInventoryBookedQuantityId,
	...
	* @param expirationDate the expiration date
	*/
	public static void removeByLt_ExpirationDate(Date expirationDate) {
		getPersistence().removeByLt_ExpirationDate(expirationDate);
	}
	...
	* @return the number of matching commerce inventory booked quantities
	*/
	public static int countByLt_ExpirationDate(Date expirationDate) {
		return getPersistence().countByLt_ExpirationDate(expirationDate);
	}
