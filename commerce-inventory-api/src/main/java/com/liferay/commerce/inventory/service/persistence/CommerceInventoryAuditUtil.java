...
public class CommerceInventoryAuditUtil {
	...
	* @return the matching commerce inventory audits
	*/
	public static List<CommerceInventoryAudit> findByLt_CreateDate(
		Date createDate) {
		return getPersistence().findByLt_CreateDate(createDate);
	}
	...
	*/
	public static List<CommerceInventoryAudit> findByLt_CreateDate(
		...
		return getPersistence().findByLt_CreateDate(createDate, start, end);
	}
	...
	*/
	public static List<CommerceInventoryAudit> findByLt_CreateDate(
		...
		OrderByComparator<CommerceInventoryAudit> orderByComparator) {
		return getPersistence()
				   .findByLt_CreateDate(createDate, start, end,
			orderByComparator);
	}
	...
	* @throws NoSuchInventoryAuditException if a matching commerce inventory audit could not be found
	*/
	public static CommerceInventoryAudit findByLt_CreateDate_First(
		Date createDate,
		OrderByComparator<CommerceInventoryAudit> orderByComparator)
		throws com.liferay.commerce.inventory.exception.NoSuchInventoryAuditException {
		return getPersistence()
				   .findByLt_CreateDate_First(createDate, orderByComparator);
	}
	...
	* @return the first matching commerce inventory audit, or <code>null</code> if a matching commerce inventory audit could not be found
	*/
	public static CommerceInventoryAudit fetchByLt_CreateDate_First(
		Date createDate,
		OrderByComparator<CommerceInventoryAudit> orderByComparator) {
		return getPersistence()
				   .fetchByLt_CreateDate_First(createDate, orderByComparator);
	}
	...
	* @throws NoSuchInventoryAuditException if a matching commerce inventory audit could not be found
	*/
	public static CommerceInventoryAudit findByLt_CreateDate_Last(
		Date createDate,
		OrderByComparator<CommerceInventoryAudit> orderByComparator)
		throws com.liferay.commerce.inventory.exception.NoSuchInventoryAuditException {
		return getPersistence()
				   .findByLt_CreateDate_Last(createDate, orderByComparator);
	}
	...
	* @return the last matching commerce inventory audit, or <code>null</code> if a matching commerce inventory audit could not be found
	*/
	public static CommerceInventoryAudit fetchByLt_CreateDate_Last(
		Date createDate,
		OrderByComparator<CommerceInventoryAudit> orderByComparator) {
		return getPersistence()
				   .fetchByLt_CreateDate_Last(createDate, orderByComparator);
	}
	...
	* @throws NoSuchInventoryAuditException if a commerce inventory audit with the primary key could not be found
	*/
	public static CommerceInventoryAudit[] findByLt_CreateDate_PrevAndNext(
		long commerceInventoryAuditId, Date createDate,
		OrderByComparator<CommerceInventoryAudit> orderByComparator)
		throws com.liferay.commerce.inventory.exception.NoSuchInventoryAuditException {
		return getPersistence()
				   .findByLt_CreateDate_PrevAndNext(commerceInventoryAuditId,
	...
	* @param createDate the create date
	*/
	public static void removeByLt_CreateDate(Date createDate) {
		getPersistence().removeByLt_CreateDate(createDate);
	}
	...
	* @return the number of matching commerce inventory audits
	*/
	public static int countByLt_CreateDate(Date createDate) {
		return getPersistence().countByLt_CreateDate(createDate);
	}
