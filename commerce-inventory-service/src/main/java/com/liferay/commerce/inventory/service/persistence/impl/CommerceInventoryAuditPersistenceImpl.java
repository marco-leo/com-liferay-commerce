...
public class CommerceInventoryAuditPersistenceImpl extends BasePersistenceImpl<CommerceInventoryAudit>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_LT_CREATEDATE =
		new FinderPath(CommerceInventoryAuditModelImpl.ENTITY_CACHE_ENABLED,
			CommerceInventoryAuditModelImpl.FINDER_CACHE_ENABLED,
			CommerceInventoryAuditImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByLt_CreateDate",
			new String[] {
				Date.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_LT_CREATEDATE =
		new FinderPath(CommerceInventoryAuditModelImpl.ENTITY_CACHE_ENABLED,
			CommerceInventoryAuditModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByLt_CreateDate",
	 ...
	 */
	@Override
	public List<CommerceInventoryAudit> findByLt_CreateDate(Date createDate) {
		return findByLt_CreateDate(createDate, QueryUtil.ALL_POS,
	...
	public List<CommerceInventoryAudit> findByLt_CreateDate(Date createDate,
		int start, int end) {
		return findByLt_CreateDate(createDate, start, end, null);
	}
	...
	public List<CommerceInventoryAudit> findByLt_CreateDate(Date createDate,
		int start, int end,
		OrderByComparator<CommerceInventoryAudit> orderByComparator) {
		return findByLt_CreateDate(createDate, start, end, orderByComparator,
			true);
	}
	...
	public List<CommerceInventoryAudit> findByLt_CreateDate(Date createDate,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_LT_CREATEDATE;
		...
		if (list == null) {
			...
			if (createDate == null) {
				query.append(_FINDER_COLUMN_LT_CREATEDATE_CREATEDATE_1);
			}
			else {
				bindCreateDate = true;

				query.append(_FINDER_COLUMN_LT_CREATEDATE_CREATEDATE_2);
			}
	 ...
	 */
	@Override
	public CommerceInventoryAudit findByLt_CreateDate_First(Date createDate,
		OrderByComparator<CommerceInventoryAudit> orderByComparator)
		throws NoSuchInventoryAuditException {
		CommerceInventoryAudit commerceInventoryAudit = fetchByLt_CreateDate_First(createDate,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceInventoryAudit fetchByLt_CreateDate_First(Date createDate,
		OrderByComparator<CommerceInventoryAudit> orderByComparator) {
		List<CommerceInventoryAudit> list = findByLt_CreateDate(createDate, 0,
				1, orderByComparator);
	 ...
	 */
	@Override
	public CommerceInventoryAudit findByLt_CreateDate_Last(Date createDate,
		OrderByComparator<CommerceInventoryAudit> orderByComparator)
		throws NoSuchInventoryAuditException {
		CommerceInventoryAudit commerceInventoryAudit = fetchByLt_CreateDate_Last(createDate,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceInventoryAudit fetchByLt_CreateDate_Last(Date createDate,
		OrderByComparator<CommerceInventoryAudit> orderByComparator) {
		int count = countByLt_CreateDate(createDate);

		if (count == 0) {
			return null;
		}

		List<CommerceInventoryAudit> list = findByLt_CreateDate(createDate,
	 ...
	 */
	@Override
	public CommerceInventoryAudit[] findByLt_CreateDate_PrevAndNext(
		...
		try {
			...
			array[0] = getByLt_CreateDate_PrevAndNext(session,
					commerceInventoryAudit, createDate, orderByComparator, true);

			array[1] = commerceInventoryAudit;

			array[2] = getByLt_CreateDate_PrevAndNext(session,
	...
	protected CommerceInventoryAudit getByLt_CreateDate_PrevAndNext(
	 ...
	 */
	@Override
	public void removeByLt_CreateDate(Date createDate) {
		for (CommerceInventoryAudit commerceInventoryAudit : findByLt_CreateDate(
	 ...
	 */
	@Override
	public int countByLt_CreateDate(Date createDate) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_LT_CREATEDATE;
	...
	private static final String _FINDER_COLUMN_LT_CREATEDATE_CREATEDATE_1 = "commerceInventoryAudit.createDate IS NULL";
	private static final String _FINDER_COLUMN_LT_CREATEDATE_CREATEDATE_2 = "commerceInventoryAudit.createDate < ?";
