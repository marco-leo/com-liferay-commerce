...
public class CommerceInventoryBookedQuantityPersistenceImpl
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_LT_EXPIRATIONDATE =
		new FinderPath(CommerceInventoryBookedQuantityModelImpl.ENTITY_CACHE_ENABLED,
			CommerceInventoryBookedQuantityModelImpl.FINDER_CACHE_ENABLED,
			CommerceInventoryBookedQuantityImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByLt_ExpirationDate",
			new String[] {
				Date.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_LT_EXPIRATIONDATE =
		new FinderPath(CommerceInventoryBookedQuantityModelImpl.ENTITY_CACHE_ENABLED,
			CommerceInventoryBookedQuantityModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"countByLt_ExpirationDate", new String[] { Date.class.getName() });
	 ...
	 */
	@Override
	public List<CommerceInventoryBookedQuantity> findByLt_ExpirationDate(
		Date expirationDate) {
		return findByLt_ExpirationDate(expirationDate, QueryUtil.ALL_POS,
	...
	public List<CommerceInventoryBookedQuantity> findByLt_ExpirationDate(
		...
		return findByLt_ExpirationDate(expirationDate, start, end, null);
	}
	...
	public List<CommerceInventoryBookedQuantity> findByLt_ExpirationDate(
		Date expirationDate, int start, int end,
		OrderByComparator<CommerceInventoryBookedQuantity> orderByComparator) {
		return findByLt_ExpirationDate(expirationDate, start, end,
	...
	public List<CommerceInventoryBookedQuantity> findByLt_ExpirationDate(
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_LT_EXPIRATIONDATE;
		...
		if (list == null) {
			...
			if (expirationDate == null) {
				query.append(_FINDER_COLUMN_LT_EXPIRATIONDATE_EXPIRATIONDATE_1);
			}
			else {
				bindExpirationDate = true;

				query.append(_FINDER_COLUMN_LT_EXPIRATIONDATE_EXPIRATIONDATE_2);
			}
	 ...
	 */
	@Override
	public CommerceInventoryBookedQuantity findByLt_ExpirationDate_First(
		Date expirationDate,
		OrderByComparator<CommerceInventoryBookedQuantity> orderByComparator)
		throws NoSuchInventoryBookedQuantityException {
		CommerceInventoryBookedQuantity commerceInventoryBookedQuantity = fetchByLt_ExpirationDate_First(expirationDate,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceInventoryBookedQuantity fetchByLt_ExpirationDate_First(
		Date expirationDate,
		OrderByComparator<CommerceInventoryBookedQuantity> orderByComparator) {
		List<CommerceInventoryBookedQuantity> list = findByLt_ExpirationDate(expirationDate,
	 ...
	 */
	@Override
	public CommerceInventoryBookedQuantity findByLt_ExpirationDate_Last(
		Date expirationDate,
		OrderByComparator<CommerceInventoryBookedQuantity> orderByComparator)
		throws NoSuchInventoryBookedQuantityException {
		CommerceInventoryBookedQuantity commerceInventoryBookedQuantity = fetchByLt_ExpirationDate_Last(expirationDate,
				orderByComparator);
	 ...
	 */
	@Override
	public CommerceInventoryBookedQuantity fetchByLt_ExpirationDate_Last(
		Date expirationDate,
		OrderByComparator<CommerceInventoryBookedQuantity> orderByComparator) {
		int count = countByLt_ExpirationDate(expirationDate);
	 ...
	 */
	@Override
	public CommerceInventoryBookedQuantity[] findByLt_ExpirationDate_PrevAndNext(
		...
		try {
			...
			array[0] = getByLt_ExpirationDate_PrevAndNext(session,
					commerceInventoryBookedQuantity, expirationDate,
					orderByComparator, true);

			array[1] = commerceInventoryBookedQuantity;

			array[2] = getByLt_ExpirationDate_PrevAndNext(session,
					commerceInventoryBookedQuantity, expirationDate,
	...
	protected CommerceInventoryBookedQuantity getByLt_ExpirationDate_PrevAndNext(
		Session session,
		CommerceInventoryBookedQuantity commerceInventoryBookedQuantity,
		Date expirationDate,
		OrderByComparator<CommerceInventoryBookedQuantity> orderByComparator,
	 ...
	 */
	@Override
	public void removeByLt_ExpirationDate(Date expirationDate) {
		for (CommerceInventoryBookedQuantity commerceInventoryBookedQuantity : findByLt_ExpirationDate(
	 ...
	 */
	@Override
	public int countByLt_ExpirationDate(Date expirationDate) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_LT_EXPIRATIONDATE;
	...
	private static final String _FINDER_COLUMN_LT_EXPIRATIONDATE_EXPIRATIONDATE_1 =
		"commerceInventoryBookedQuantity.expirationDate IS NULL";
	private static final String _FINDER_COLUMN_LT_EXPIRATIONDATE_EXPIRATIONDATE_2 =
		"commerceInventoryBookedQuantity.expirationDate < ?";
